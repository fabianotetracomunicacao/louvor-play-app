    ...
    return (
        <div className="h-screen flex flex-col bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 overflow-hidden font-sans">
            ...
            <div className="flex-1 flex overflow-hidden">
                <div className={`flex-1 overflow-y-auto p-4 md:p-8 space-y-2 max-w-5xl mx-auto w-full custom-scrollbar transition-all duration-300 ${showSource ? 'lg:mr-[400px]' : ''}`}>
